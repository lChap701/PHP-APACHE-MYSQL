...
<!-- This code is part of a separate PHP file that is used to allow users to login and demonstrates the use of decision structure, functions, and the require statement -->
<div id="special-tag">
	...
	<?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {	// checks if the login form has been submitted
