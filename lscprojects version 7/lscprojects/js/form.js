...
function servPrice() {
    ...
    if (serv.checked == true) {
        discountAmt = (price * discount).toFixed(2);
        num = (price - discountAmt).toFixed(2);
        cost.value = "$" + thousands_separators(num);
    }
}
